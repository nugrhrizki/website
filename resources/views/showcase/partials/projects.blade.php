    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl">
            <div class="h-52 flex flex-col justify-center items-center bg-blue-600 rounded-t-xl">
                <svg class="w-28 h-28" width="56" height="56" viewBox="0 0 56 56" fill="none"
            ...
            <div class="mt-auto flex border-t border-gray-200 divide-x divide-gray-200">
                ...
                <a class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-ee-xl bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none"
                    href="#">
                    View API
                </a>
            </div>
        ...
        <div class="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl">
            ...
            <div class="p-4 md:p-6">
                ...
                <h3 class="text-xl font-semibold text-gray-800">Asana</h3>
                <p class="mt-3 text-gray-500">
        ...
        <div class="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl">
            ...
            <div class="p-4 md:p-6">
                ...
                <h3 class="text-xl font-semibold text-gray-800">Slack</h3>
                <p class="mt-3 text-gray-500">
