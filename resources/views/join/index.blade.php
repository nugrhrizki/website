        ...
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            <div class="grid md:grid-cols-2 items-center gap-12">
                <div>
                    ...
                    <div class="mt-8">
                        ...
                        <ul class="mt-2 space-y-2">
                            <li class="flex space-x-3">
                                <svg class="flex-shrink-0 mt-0.5 h-5 w-5 text-gray-600" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <li class="flex space-x-3">
                                <svg class="flex-shrink-0 mt-0.5 h-5 w-5 text-gray-600"
                    ...
                    <div class="mt-8">
                        <h2 class="text-lg font-semibold text-gray-800">Enjoyed by:</h2>
                        ...
                        <div class="mt-4 flex gap-x-8">
                            <svg class="w-20 h-auto" width="106" height="36" viewBox="0 0 106 36" fill="none"
                                ...
                                <g clip-path="url(#clip0)">
                                    <path
                                        ...
                                        fill="currentColor" class="fill-gray-500"></path>
                                </g>
                                <defs>
                                    <clipPath id="clip0">
                                        <rect width="105.474" height="35" fill="currentColor" class="fill-gray-500"
                                            transform="translate(0 0.26355)"></rect>
                                    </clipPath>
                                </defs>
                            </svg>

                            <svg class="w-20 h-auto" width="140" height="47" viewBox="0 0 140 47" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <svg class="w-20 h-auto" width="200" height="67" viewBox="0 0 200 67" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="mt-10 flex items-center gap-x-5">
                        <div class="flex -space-x-2">
                            ...
                            <img class="inline-block h-8 w-8 rounded-full ring-2 ring-white"
                                ...
                                alt="Image Description" />
                            <span
                                class="inline-flex justify-center items-center h-8 w-8 rounded-full bg-blue-600 text-white ring-2 ring-white">
                        ...
                        <span class="text-sm text-gray-500">
                            Trusted by over 37k customer</span>
                    </div>
                </div>
                            ...
                            <div class="mt-6 grid gap-4 lg:gap-6">
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                                    <div>
                                        <label for="hs-firstname-hire-us-1"
                                            class="block mb-2 text-sm text-gray-700 font-medium">First Name</label>
                                    ...
                                    <div>
                                        <label for="hs-lastname-hire-us-1"
                                            class="block mb-2 text-sm text-gray-700 font-medium">Last Name</label>
                                ...
                                <div>
                                    <label for="hs-work-email-hire-us-1"
                                        class="block mb-2 text-sm text-gray-700 font-medium">Work Email</label>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                                    <div>
                                        <label for="hs-company-hire-us-1"
                                            class="block mb-2 text-sm text-gray-700 font-medium">Company</label>
                                    ...
                                    <div>
                                        <label for="hs-company-website-hire-us-1"
                                            class="block mb-2 text-sm text-gray-700 font-medium">Company
                                            Website</label>
                                ...
                                <div>
                                    <label for="hs-about-hire-us-1"
                                        class="block mb-2 text-sm text-gray-700 font-medium">Details</label>
                            ...
                            <div class="mt-3 flex">
                                <div class="flex">
                                    <input id="remember-me" name="remember-me" type="checkbox"
                                        class="shrink-0 mt-1.5 border-gray-200 rounded text-blue-600 pointer-events-none focus:ring-blue-500" />
                                </div>
                                <div class="ms-3">
                                    <label for="remember-me" class="text-sm text-gray-600">By submitting this form
                                        I have read and acknowledged the <a
